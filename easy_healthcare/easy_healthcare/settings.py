"""
Django settings for easy_healthcare project.
...
ROOT_URLCONF = "easy_healthcare.urls"
...
WSGI_APPLICATION = "easy_healthcare.wsgi.application"
...
MEDIA_URL_VIDEOS = '/media/videos/'
MEDIA_URL_AUDIO = '/media/audio/'
